...
$mw->title('Hypernetwork at clocktime =33');
my $pane = $mw->Frame; 
...
$canvas->createRectangle(21,41,38,58,-fill=>'maroon1');
...
$canvas->createRectangle(261,101,278,118,-fill=>'maroon1');
...
$canvas->update();
$canvas->postscript(-file=>'plotorg/org-t33.ps');
MainLoop;
