...
$mw->title('Hypernetwork at clocktime =45');
my $pane = $mw->Frame; 
...
$canvas->createRectangle(281,101,298,118,-fill=>'SkyBlue1');
...
$canvas->createRectangle(301,161,318,178,-fill=>'SkyBlue1');
...
$canvas->update();
$canvas->postscript(-file=>'plotorg/org-t45.ps');
MainLoop;
