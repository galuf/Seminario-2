...
$mw->title('Hypernetwork at clocktime =71');
my $pane = $mw->Frame; 
...
$canvas->createRectangle(1,141,18,158,-fill=>'maroon1');
...
$canvas->createRectangle(141,161,158,178,-fill=>'maroon1');
...
$canvas->createRectangle(181,101,198,118,-fill=>'maroon1');
...
$canvas->update();
$canvas->postscript(-file=>'plotorg/org-t71.ps');
MainLoop;
