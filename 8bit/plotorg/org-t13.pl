...
$mw->title('Hypernetwork at clocktime =13');
my $pane = $mw->Frame; 
...
$canvas->createRectangle(1,121,18,138,-fill=>'SkyBlue1');
...
$canvas->createRectangle(21,201,38,218,-fill=>'SkyBlue1');
...
$canvas->update();
$canvas->postscript(-file=>'plotorg/org-t13.ps');
MainLoop;
